...
PROTOCOLOS POSIBLES (id interno si AUTO): cholecystitis, appendicitis, thyroid_tirads, breast_birads, bosniak, rotator_cuff, knee_msk, hepatic, renal, scrotal, diverticulitis, achilles, muscle_injury, generic.
...
- knee_msk: rodilla MSK (meniscos, LCM/LCL, mecanismo extensor, derrame, quiste de Baker, cartílago; no inventar LCA sin evidencia).
