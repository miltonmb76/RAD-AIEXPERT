...
export default function ThighPosteriorAnatomyViewer({
  ...
  const getSimplifiedDescriptionByState = (id: string, state: string): string => {
    ...
    const standardStates = [
      ...
      "neuropatia", "engrosamiento", "contusion", "desgarro_parcial", "desgarro"
    ];
  ...
  const getDefaultDescription = (id: string, state: string): string => {
    ...
    const standardStates = [
      "normal", "no_descrito", "desgarro_miofascial", "desgarro_intramuscular", "desgarro_completo",
      "neuropatia", "engrosamiento", "contusion", "desgarro"
    ];
  ...
  const generateTableMarkdown = () => {
    ...
    if (!hasRows) {
      md += `| *Sin hallazgos patológicos* | *Todas las estructuras de compartimento posterior se reportan normales.* |\n`;
    }
            ...
            <div className="mb-4 space-y-1">
              ...
              <div className="flex flex-col gap-2">
                <input
                  ...
                  className="w-full bg-slate-955 border border-slate-800 rounded-xl px-3 py-2 text-xs text-slate-200 font-mono focus:outline-none focus:border-violet-500/50"
                />
          ...
          <div className="bg-slate-950/20 rounded-2xl border border-slate-850 p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-[160px] overflow-y-auto pr-1">
              ...
              {Object.values(states).every(s => s === "no_descrito" || s === "normal") && (!additionalFindings || additionalFindings.length === 0) && (
                <div className="col-span-2 py-4 text-center text-slate-500 italic text-xs font-mono">
