    ...
    <div className="bg-white rounded-xl shadow-lg border border-sky-100 overflow-hidden transition-all duration-300">
      ...
      {!isGenerating && kneeData && (
        <div className="p-5 space-y-6">
          ...
          <div className="rounded-2xl border border-sky-500/30 bg-gradient-to-br from-slate-950 via-slate-950 to-sky-950/40 p-4 space-y-3 text-slate-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="md:col-span-2 rounded-xl border border-sky-800/40 bg-slate-950/70 p-3">
                <p className="text-[10px] font-mono font-black uppercase tracking-widest text-sky-300 mb-1">Resumen del rodilla</p>
                {isEditingText ? (
              ...
              <div className="rounded-xl border border-slate-700/70 bg-slate-950/70 p-3">
                <p className="text-[10px] font-mono font-black uppercase tracking-widest text-cyan-300 mb-1">Morfología / tendón dominante</p>
                {isEditingText ? (
